...
Intuitively, `"cat->cat;135->135;hello->hello;?"` feels conceptually strange:
...
`"?"` tries to fix this by just removing the parts that don't make sense. It could perhaps be improved by adding a prompt like `"hello->there;?->"`.
